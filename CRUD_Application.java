//CRUD based application devleoped for students 
...
//Creating a class with a name StudentDBCrudOperations
public class CRUD_Application{
    ...
    public static void main(String[] args) throws ClassNotFoundException,SQLException 
    {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/ACP_project", "root", "root");
        ...
        do 
        {
            ...
            case 1:
                    ...
                    String createSql = "INSERT INTO Students (firstName, lastName, age, Grade) VALUES (?, ?, ?, ?)";
                ...
                case 3:
                    ...
                    switch (updateChoice) 
                    {
                        case 1:
                            ...
                            updateSql = "UPDATE Students SET firstName = ?, lastName = ? WHERE student_id = ?";
